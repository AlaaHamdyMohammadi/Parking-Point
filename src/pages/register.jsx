      ...
      <div className={`row`}>
        <div className={`col-12 col-md-7`}>
          <div className="mb-5 d-flex">
            <div className={`${classes.loginBtn} bgColor text-white btn ms-5`} onClick={registerClicked} >
              إنشاء حساب
            </div>
            <div className={`${classes.loginBtn} bgColor text-white btn`} onClick={loginClicked} >
              تسجيل الدخول
            </div>
          </div>
