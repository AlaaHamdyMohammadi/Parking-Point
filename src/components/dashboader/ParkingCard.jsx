  ...
  return (
    <>
      {parkingplaces.map((item, index) => (
        <div key={item.id} className="mb-3 col-12 col-md-9 my-md-5 my-2 row">
              ...
              <div className="col-4 d-flex justify-content-between align-items-center">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <Link className="dropdown-item" to={`/dashboard/edit_parking/:ParkingId`}>
                        تحرير
                      </Link>
                    </li>
