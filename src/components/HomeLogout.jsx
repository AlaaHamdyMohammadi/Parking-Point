    ...
    <div className={`row`}>
        ...
        <div className={`col-12 col-md-6 d-flex align-items-center justify-content-center`}>
            <div className={`col-7`}>
                ...
                <div className={`${classes.font}`}>موقع الكتروني لحجز مواقف للسيارات هو نظام يستخدم لحجز المواقف
                    المتاحة من قبل المنازل و المباني وتيسير عملية حجزها.
                    يهدف المشروع إلى تحسين تجربة مستخدمي السيارات في العثور على مواقف بشكل
                    أكثر فعالية. يسمح للمستخدمين برؤية المواقف الشاغرة وحجزها عبر هواتفهم.
                    المشروع يعتمد على موقع الكتروني للكشف عن توفرها، مما يتيح للسائقين معرفة المواقف
                    الفارغة قبل وصولهم إلى المكان. ويظهر لهم  المواقف الشاغرة بشكل فعال.
                    تتضمن الخدمة أيضًا نظام دفع آمن يتيح للمستخدمين دفع رسوم
                    الاستخدام أو حجز المواقف عبر الموقع الالكتروني. يعمل المشروع على توفير
                    مواقف للسيارات بشكل أمن وتجنب الوقوف العشوائي في المناطق.المزدحمة</div>
            </div>
        </div>
    </div>
</div>
